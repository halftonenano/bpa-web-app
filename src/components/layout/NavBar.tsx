...
function LinkButton({
  ...
  return (
    <Link
      className="flex w-full flex-col items-end justify-end rounded-[0.5rem] border px-5 pb-3 pt-6 text-right font-bold shadow-sm transition duration-300 hover:bg-white hover:shadow-md"
      href={href}
    >
      {icon}
      {name}
